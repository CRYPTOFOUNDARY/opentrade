...
exports.recaptcha_pub_key = "6LcnJnMUAAAAAGyW0EzSAaq7K4Jsm1eoQS4vqhT4"
...
const PRIVATE_CONSTANTS_PATH = "./modules/private"

exports.dbTables = [
  {
    name: "KeyValue",
    cols: [["key", "TEXT UNIQUE PRIMARY KEY"], ["value", "TEXT"]]
  },
  {
    name: "users",
    cols: [["login", "TEXT UNIQUE"], ["email", "TEXT UNIQUE"], ["password", "TEXT"], ["info", "TEXT"]],
    commands: "PRIMARY KEY (login, email)"
  },
  {
    name: "chatban",
    cols: [["userID", "TEXT UNIQUE"], ["startBanTime", "INTEGER"], ["endBanTime", "INTEGER"], ["comment", "TEXT"]],
  ...
  {
    name: "sessions",
    cols: [["token", "TEXT UNIQUE PRIMARY KEY"], ["time", "TEXT"], ["userid", "INTEGER"]]
  },
  {
    name: "support",
    cols: [
  ...
  {
    name: "balance",
    cols: [["userID", "TEXT"], ["coin", "TEXT"], ["balance", "TEXT"], ["history", "TEXT"], ["info", "TEXT"]],
  ...
  {
    name: "balancelog",
    cols: [["userID", "TEXT"], ["coin", "TEXT"], ["amount", "TEXT"], ["time", "INTEGER"], ["log", "TEXT"]]
  }
]
...
exports.DEBUG_MODE = true //process.env.PORT ? true : false
...
exports.DONATORS = [{userID: 1, percent: 99}]
...
exports.SSL_options = {
  key: fs.readFileSync(PRIVATE.SSL_KEY),
  cert: fs.readFileSync(PRIVATE.SSL_CERT)
}

////////////////////////////////////////////////////////////////////////////////////

exports.IsDashFork = function(name) {
  for (let i = 0; i < DashForks.length; i++) if (name == DashForks[i]) return true
  return false
}

let g_IP_connections = {}
exports.IsAllowedAddress = function(addr) {
  if (PRIVATE.IsUnlimitedAddress && PRIVATE.IsUnlimitedAddress(addr)) return true

  if (!g_IP_connections[addr]) g_IP_connections[addr] = {n: 0}
  if (g_IP_connections[addr].n < 0) g_IP_connections[addr].n = 0
  if (g_IP_connections[addr].n > MAX_IP_CONNECTIONS) return false

  g_IP_connections[addr].n++
  return true
}
exports.ReleaseAddress = function(addr) {
  if (PRIVATE.IsUnlimitedAddress && PRIVATE.IsUnlimitedAddress(addr)) return

  if (g_IP_connections[addr] && g_IP_connections[addr].n > 0) g_IP_connections[addr].n--
}
