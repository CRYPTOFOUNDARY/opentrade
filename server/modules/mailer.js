...
exports.SendPIN = function(email, user, pin, callback) {
  ...
  const body =
    ...
    unescape(user) +
    "</h3>" +
    "<p>You have recently reveived instructions to enter a one-time authentication code in order to log into your " +
    g_constants.OPENTRADE +
    " account. Your code is:</p>" +
    "<p>" +
    pin +
    "</p>" +
    "<p>For security reasons, this code will expire in 5 minutes.</p>" +
    "<p>If you did not request this code? you should <a href='https://" +
    g_constants.DOMAIN +
    "/profile'>change</a> or <a href='https://" +
    g_constants.DOMAIN +
    "/password_reset'>reset</a> your " +
    g_constants.OPENTRADE +
    " password immidiately.</p>" +
...
exports.SendSignupConfirmation = function(email, url, urlCheck, callback) {
  ...
  const body =
    "<h3>Hello</h3>" +
    "<p>You received this message as you have given this e-mail address during registration at " +
    urlHREF +
    "</p>" +
...
exports.SendPasswordResetConfirmation = function(email, user, url, urlCheck, callback) {
  ...
  const body =
    ...
    unescape(user) +
    "</h3>" +
    "<p>Someone requested that the password for your " +
    g_constants.OPENTRADE +
    " account be reset</p>" +
    "<p>" +
    confirmHREF +
...
exports.SendWithdrawConfirmation = function(email, user, url, urlCheck, callback) {
  ...
  const body =
    ...
    unescape(user) +
    "</h3>" +
    "<p>Someone requested withdraw from your " +
    g_constants.OPENTRADE +
    " balance</p>" +
    "<p>" +
    confirmHREF +
